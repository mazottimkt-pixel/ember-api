...
describe("estrutura conversacional do WhatsApp",()=>{
  ...
  it("menu solicitado usa lista nativa como interface primária",()=>{const menu=renderMenu("main");expect(menu).toContain("lista abaixo");expect(menu).not.toMatch(/\b1\s*[—-]|\b2\s*[—-]/);});
